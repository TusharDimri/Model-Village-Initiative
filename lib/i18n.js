...
const resources = {
  en: {
    translation: {
      ...
      'register.pradhanNote': 'Village Pradhans can register for free. Normal registration applies for others.',
      'register.pradhanButton': 'Pradhan Registration (Free)',
      'register.normalButton': 'Normal Registration',
  ...
  hi: {
    translation: {
      ...
      'register.pradhanNote': 'ग्राम प्रधान निःशुल्क पंजीकरण कर सकते हैं। अन्य लोगों के लिए सामान्य पंजीकरण लागू होगा।',
      'register.pradhanButton': 'प्रधान पंजीकरण (निःशुल्क)',
      'register.normalButton': 'सामान्य पंजीकरण',
