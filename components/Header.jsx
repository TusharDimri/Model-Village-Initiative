...
export default function Header() {
    ...
    return (
        <>
            ...
            >
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center h-[70px]">
                    ...
                    <nav className="hidden md:flex gap-8 text-sm font-medium">
                        <Link href="/" className="hover:text-[#F9B233] transition">
                            {t("nav.home")}
                        </Link>
                        <Link href="/#about" className="hover:text-[#F9B233] transition">
                            {t("nav.about")}
                        </Link>
                        <Link href="/#initiatives" className="hover:text-[#F9B233] transition">
                            {t("nav.initiatives")}
                        </Link>
                        <Link href="/#conference" className="hover:text-[#F9B233] transition">
                            {t("nav.conference")}
                        </Link>
                        <Link href="/contact" className="hover:text-[#F9B233] transition">
                            {t("nav.contact")}
                        </Link>
                    </nav>
            ...
            <a
                href="https://wa.me/919811431604?text=Hello%2C%20I%20would%20like%20to%20know%20more%20about%20the%20Model%20Villages%20initiative."
                target="_blank"
